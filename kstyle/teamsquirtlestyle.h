#ifndef teamsquirtlestyle_h
#define teamsquirtlestyle_h
...
namespace TeamSquirtle
{
    ...
    private:
        ...
        //* tabbar data
        TeamSquirtlePrivate::TabBarData* _tabBarData;
