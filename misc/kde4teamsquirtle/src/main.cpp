...
static const QString defaultLookAndFeelPackage = "org.kde.teamsquirtle.desktop";
...
void updateKdeGlobals()
{
    ...
    const QString widgetStyle = readConfigValue(lnfConfig, defaultLnfConfig, "KDE", "widgetStyle", "TeamSquirtle").toString();
    const QString colorScheme = readConfigValue(lnfConfig, defaultLnfConfig, "General", "ColorScheme", "TeamSquirtle").toString();
    const QString icons = readConfigValue(lnfConfig, defaultLnfConfig, "Icons", "Theme", "teamsquirtle").toString();
