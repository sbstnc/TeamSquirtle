...
#include "teamsquirtledecoration.h"

#include "teamsquirtle.h"
#include "teamsquirtlesettingsprovider.h"
#include "config-teamsquirtle.h"
#include "config/teamsquirtleconfigwidget.h"

#include "teamsquirtlebutton.h"
#include "teamsquirtlesizegrip.h"
...
K_PLUGIN_FACTORY_WITH_JSON(
    TeamSquirtleDecoFactory,
    "teamsquirtle.json",
    registerPlugin<TeamSquirtle::Decoration>();
    registerPlugin<TeamSquirtle::Button>(QStringLiteral("button"));
    registerPlugin<TeamSquirtle::ConfigWidget>(QStringLiteral("kcmodule"));
    )
...
namespace TeamSquirtle
{
    ...
    QPair<QRect,Qt::Alignment> Decoration::captionRect() const
    {
        if( hideTitleBar() ) return qMakePair( QRect(), Qt::AlignCenter );
            ...
            (Metrics::TitleBar_SideMargin + 2)*settings()->smallSpacing():
...
#include "teamsquirtledecoration.moc"
