...
#include "teamsquirtlestyleconfigmodule.h"

#include <KPluginFactory>


K_PLUGIN_FACTORY(
    TeamSquirtleStyleConfigFactory,
    registerPlugin<TeamSquirtle::ConfigurationModule>(QStringLiteral("kcmodule"));
)

#include "teamsquirtlestyleconfigmodule.moc"
