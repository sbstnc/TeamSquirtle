#ifndef teamsquirtle_h
#define teamsquirtle_h
...
Q_DECLARE_OPERATORS_FOR_FLAGS( TeamSquirtle::AnimationModes )
Q_DECLARE_OPERATORS_FOR_FLAGS( TeamSquirtle::Corners )
Q_DECLARE_OPERATORS_FOR_FLAGS( TeamSquirtle::Sides )
