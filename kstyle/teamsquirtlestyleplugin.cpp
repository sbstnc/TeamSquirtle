...
#include "teamsquirtlestyleplugin.h"
#include "teamsquirtlestyle.h"

#include <QApplication>

#if QT_VERSION < 0x050000
Q_EXPORT_PLUGIN2( teamsquirtle-qt, TeamSquirtle::StylePlugin )
#endif
...
namespace TeamSquirtle
{
    ...
    {
        if( key.toLower() == QStringLiteral( "teamsquirtle" ) )
        {
    ...
    { return QStringList( QStringLiteral( "TeamSquirtle" ) ); }
