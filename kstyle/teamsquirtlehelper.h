#ifndef teamsquirtle_helper_h
#define teamsquirtle_helper_h
...
#include "teamsquirtleanimationdata.h"
...
#include <xcb/xcb.h>
 ...
 namespace TeamSquirtle
 {
    ...
    //* teamsquirtle style helper class.
    /** contains utility functions used at multiple places in both teamsquirtle style and teamsquirtle window decoration */
    class Helper
    {
    public:
        ...
        //* generic frame
        void renderFrame( QPainter*, const QRect&, const QColor& color, const QColor& outline = QColor(), bool roundCorners = true ) const;
        ...
        //* tab widget frame
        void renderTabWidgetFrame( QPainter*, const QRect&, const QColor& color, const QColor& outline, Corners, bool roundCorners = true ) const;
